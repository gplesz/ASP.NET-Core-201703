...
using FamilyPhotosWithIdentity.Models.AccountViewModels;
...
namespace FamilyPhotosWithIdentity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // https://stackoverflow.com/a/41580352/208922
        [HttpGet]
        [AllowAnonymous]
        public IActionResult AccessDenied(string returnUrl = null)
        {
            // workaround
            //if (Request.Cookies["AspNetCore.Identity.External"] != null)
            //{
            ...
            return RedirectToAction(nameof(Login), 
                new {
                    returnUrl = returnUrl,
                    Message = $"You must be in the Administrators role to access this page: {returnUrl}."
                });
